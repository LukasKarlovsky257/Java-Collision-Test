...
public class GameGraphics extends JFrame {
    ...
    public class Draw extends JPanel{
        ...
        protected void paintComponent(Graphics g) {
            ...
            g.setColor(Color.BLACK);
            g.drawLine(logic.getLine1().getX1(), logic.getLine1().getY1(), logic.getLine1().getX2(), logic.getLine1().getY2());
            g.setColor(Color.BLACK);
            g.drawLine(logic.getLine2().getX1(), logic.getLine2().getY1(), logic.getLine2().getX2(), logic.getLine2().getY2());
        }
    }
